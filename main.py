...
from src.training.targeted_pauli import run_targeted_standard
...
if __name__ == "__main__":
    ...
    elif C.EXPERIMENT_MODE == "targeted_standard":
        results = run_targeted_standard()
    elif C.EXPERIMENT_MODE == "targeted_method_suite_sample":
        results = run_method_suite_sample()
    elif C.EXPERIMENT_MODE == "targeted_method_suite_aggregate":
        results = run_method_suite_aggregate()
    else:
        raise ValueError(f"Unknown EXPERIMENT_MODE={C.EXPERIMENT_MODE!r}.")
