...
METHOD_SUITE_NUM_HAMILTONIANS = 10
...
# The targeted modes keep the existing Pauli-noise schedules, but apply them
# only to a selected subset of matched parameterized gates.
TARGET_SCORE_STEPS = 100
TARGET_SCORE_TYPE = "mean_abs_grad"
TARGET_FRACTIONS = [0.10, 0.50, 1.00]
TARGET_SELECTION_MODES = ["top", "bottom", "random"]
TARGET_SUITE_SCHEDULES = ["fixed_step", "manual"]
TARGET_RANDOM_BASE_SEED = 2701
TARGET_SAVE_MASKS = True
TARGET_INCLUDE_SHOTS = False
